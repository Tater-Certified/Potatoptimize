 ...
 */
package com.github.tatercertified.vanilla.mixin.entity.spawning.slime;
...
public abstract class RandomSlimeEntityMixin extends Mob implements Enemy {
    ...
    private static void injectQuickReturn(
    ...
    @WrapOperation(
            method = "checkSlimeSpawnRules",
            constant = @Constant(classValue = WorldGenLevel.class, ordinal = 0))
