...
import com.github.tatercertified.potatoptimize.config.mixintree.MixinTree;
...
public class PotatoptimizeConfig {
    ...
    private final List<Pair<String[], Pair<String, Boolean>>> mixinOverrides = new ArrayList<>();
